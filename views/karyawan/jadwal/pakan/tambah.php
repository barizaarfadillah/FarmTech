...
<div class="dash-cardsss">
                <div class="card-singles">
                    <h2 class="dash-title" style="margin-top: 2rem; margin-left: 2rem;"><a href="?page=jadwalpakan" style="margin-right:1rem;"><i class='bx bx-arrow-back'></i></a> Tambah Jadwal Pakan</h2>
                    <div class="card-bodys">
                        <div class="profile">
                                <form action="" method="post">
                                <div class="info-profile">
                                    <label for="">Jenis Jadwal</label></br>
                                    <input name='jenis'type="text" value="Jadwal Pakan" readonly/>
                                </div>
                                <div class="info-profile">
