...
<h2 class="dash-title">Jadwal Pemberian Pakan</h2>
            <div class="dash-cardsss">
                <div class="card-singless">
                    <a class="btn-add" href="?page=jadwalpakan&aksi=tambah">Tambah Jadwal</a>
                            ...
                            <tbody style="background-color:#D7FBE8; font-weight:500;">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;display:flex;justify-content: center;align-items: center;">
                                        <a class="btn-add" href="?page=jadwalpakan&aksi=edit&id=<?php echo $row['id_jadwal'] ;?>" style="width:65px; margin:0.5rem;">Edit</a>
                                        <a onclick="return confirm('Apakah anda yakin akan menghapus jadwal ini?')" class="btn-delete" style="width:65px; margin:0.5rem;" href="?page=jadwalpakan&aksi=hapus&id=<?php echo $row['id_jadwal'] ?>">Hapus</a>
                                    </td>
                                </tr>
                                <?php
                                 }}
