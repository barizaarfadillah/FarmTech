...
$Jadwal = new Jadwal();
$result = $Jadwal->getPenjadwalanPakan();
?>
                            ...
                            <tbody style="background-color:#D7FBE8; font-weight:500;">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;display:flex;justify-content: center;align-items: center;">
                                        ...
                                        <a id="btn-delete" class="btn-delete" style="width:65px; margin:0.5rem;" href="?page=jadwalpakan&aksi=hapus&id=<?php echo $row['id_jadwal'] ?>">Hapus</a>
                                    </td>
                                </tr>
                                <?php
                                 }}
